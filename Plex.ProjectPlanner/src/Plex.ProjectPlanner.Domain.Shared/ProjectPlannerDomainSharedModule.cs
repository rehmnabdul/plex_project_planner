...
public class ProjectPlannerDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ProjectPlannerGlobalFeatureConfigurator.Configure();
        ProjectPlannerModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<ProjectPlannerDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<ProjectPlannerResource>("ar")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/ProjectPlanner");

            options.DefaultResourceType = typeof(ProjectPlannerResource);
        ...
        {
            options.MapCodeNamespace("ProjectPlanner", typeof(ProjectPlannerResource));
        });
    }
}
