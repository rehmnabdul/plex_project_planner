...
public class ProjectPlannerDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public ProjectPlannerDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
